...
class ScaffoldThemeModel {
  final Map<String, ThemeData> _theme = {
    'light': ThemeData(
      // AppBar
      appBarTheme: AppBarTheme(
        ...
        textTheme: TextTheme(
          // old title
          headline6: TextStyle(
              color: Colors.white, fontFamily: 'Sriracha', fontSize: 22),
        ),
      ),
    ...
    'dark': ThemeData(
      ...
      appBarTheme: AppBarTheme(
        actionsIconTheme:
            IconThemeData(color: const Color(0xFF888888), size: 24),
        centerTitle: false,
  ...
  Map<String, ThemeData> get theme => _theme;
}
